...
const Navbar: React.FC = () => { const [open, setOpen] = useState(false); const go = (id: string) => { setOpen(false); scrollToSection(id); }; return <header className="wrap site-nav">
    ...
    <nav className="nav-links" aria-label="Primary">
      <a href="#work">Work</a><a href="#about">About</a><a href="#capabilities">Skills</a>
    </nav>
    ...
    {open && <div className="mobile-nav"><a href="#work" onClick={(e)=>{e.preventDefault();go("work")}}>Work</a><a href="#about" onClick={(e)=>{e.preventDefault();go("about")}}>About</a><a href="#capabilities" onClick={(e)=>{e.preventDefault();go("capabilities")}}>Skills</a><a href="#contact" onClick={(e)=>{e.preventDefault();go("contact")}}>Let&apos;s talk</a></div>}
  </header>;
};
